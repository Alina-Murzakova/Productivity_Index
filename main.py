...
data_file = "ВНГП зона 6. 1748xlsx.xlsx" # Файл для расчета
data_file_gtm = "ВНГП ГТМ.xls" # Файл новая стратегия
...
def PI(df_initial, df_gtm, data_file):
    ...
    for prod_well in wells_prod:
        ...
        # считываем Арпса
        data_prod_with_arps, df_r2_well = calc_arps(data_prod_with_Kprod, Kprod_result)
        ...
        if not df_result.empty:
            ...
            charts(data_prod, xw, sht, index_first_not_null, index_last, count_arps, Kprod_result)
